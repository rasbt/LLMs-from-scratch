...
- **Chapter 6:**
  - [Additional experiments finetuning different layers and using larger models](ch05/02_bonus_additional-experiments) 	
  - [Finetuning different models on 50k IMDB movie review dataset](ch05/03_bonus_imdb-classification) 	
