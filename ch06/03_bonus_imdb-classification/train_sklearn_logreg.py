...
def ast.literal_eval(model, X_train, y_train, X_val, y_val, X_test, y_test):
    # Making predictions
...
if __name__ == "__main__":
    ...
    ast.literal_eval(dummy_clf, X_train, y_train, X_val, y_val, X_test, y_test)

    print("\n\nLogistic regression classifier:")
    model = LogisticRegression(max_iter=1000)
    model.fit(X_train, y_train)
    ast.literal_eval(model, X_train, y_train, X_val, y_val, X_test, y_test)
