...
Then VSCode automatically checks if the recommended extensions are already installed on your system every time you open the project. You can then choose to install them or not. Those extensions provide enhanced functionality and tools helpful for this repositoy.
